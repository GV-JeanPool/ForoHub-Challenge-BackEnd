...
API REST profesional desarrollada con **Java 17 + Spring Boot 3.5.11** para el reto ForoHub de Alura. Es un sistema con autenticación JWT, CRUD de tópicos, validaciones de negocio y persistencia MySQL.
